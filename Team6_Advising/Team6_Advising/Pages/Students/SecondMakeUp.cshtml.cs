...
using static Team6_Advising.Pages.Students.FirstMakeUpModel;
    ...
    public class SecondMakeUpModel : PageModel
    {
        ...
        public void OnGet(String? id)
        {
            try
            {
                ...
                {
                    connection.Open();
                    string commandText = "SELECT Es.* FROM Exam_Student Es INNER JOIN MakeUp_Exam Me ON Es.exam_id = Me.exam_id WHERE student_id =" + student_id + "AND Me.type = 'Second_makeup'";
